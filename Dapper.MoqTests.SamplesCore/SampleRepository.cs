...
namespace Dapper.MoqTests.Samples
{
    public class SampleRepository
    {
        ...
        public SampleRepository(IDbConnectionFactory connectionFactory, IDbConnection connection)
        {
            _connectionFactory = connectionFactory;
...
where Registration = @registration", new { registration });
        ...
        public List<Car> GetCarsStoredProcedure() => connection.Query<Car>("sp.test", new { test = "yes" }, null, true, null, CommandType.StoredProcedure).ToList();
